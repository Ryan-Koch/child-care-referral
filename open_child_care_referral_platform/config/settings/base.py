...
# open_child_care_referral_platform/
APPS_DIR = BASE_DIR / "open_child_care_referral_platform"
env = environ.Env()
...
DJANGO_APPS = [
    ...
    "django.contrib.postgres",  # trigram (pg_trgm) search support
...
ADMINS = ['"Ryan Koch" <inbox@ryanakoch.com>']
